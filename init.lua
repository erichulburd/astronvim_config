...
local config = {
        ...
        lsp = {
                ...
                -- the following will support AstroNvim v3 https://github.com/AstroNvim/AstroNvim/issues/917
                -- setup_handlers = function(server, opts)
                --         require "nlspsettings"
                --         require("lspconfig")[server].setup(opts)
                -- en:
                server_registration = function(server, opts) -- handler for setting up servers
                        pcall(require, "nlspsettings") -- load nlspsettings if it hasn't been loaded
                        require("lspconfig")[server].setup(opts) -- setup the server
                end,
        },
